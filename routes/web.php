...
Route::group(['prefix'=>'admin'],function(){
	...
	//setting
	Route::get('general_setting',[SettingController::class,'general_setting'])->name('admin.general_setting');
	Route::post('update_setting',[SettingController::class,'update_setting'])->name('admin.update_setting');
	...
	// banner Routes
	Route::get('load_banner',[BannerController::class,'datatable'])->name('admin.load_banner');
	Route::get('banner_list',[BannerController::class,'index'])->name('admin.banner_list');
	Route::get('banner_create',[BannerController::class,'create'])->name('admin.banner_create');
	Route::post('banner_store',[BannerController::class,'store'])->name('admin.banner_store');
	Route::get('banner_edit/{id}',[BannerController::class,'edit'])->name('admin.banner_edit');
	Route::post('banner_update',[BannerController::class,'update'])->name('admin.banner_update');
	Route::post('banner_delete',[BannerController::class,'delete'])->name('admin.banner_delete');
