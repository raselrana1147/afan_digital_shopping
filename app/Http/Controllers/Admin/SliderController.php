       ...
       if ($request->isMethod('post'))
         {
             ...
             try{
                 ...
                 if($request->hasFile('image')){
                         ...
                         {
                               Image::make($image)->resize(60,60)->save($small_image_path);
                          }elseif ($request->type=="main") {
                               Image::make($image)->resize(1100,600)->save($small_image_path);
                               
                          }elseif ($request->type=="top") {
                               Image::make($image)->resize(1900,60)->save($small_image_path);
                               
                          }
                          else{
                             Image::make($image)->resize(1100,350)->save($small_image_path);
                          }
                 ...
                 if($request->hasFile('image')){
                       ...
                       if (File::exists(base_path('/assets/backend/image/slider/small/'.$slider->image))) 
                         ...
                         if ($request->type=='mini') 
                         {
                               ...
                               Image::make($image)->resize(1900,66)->save($small_image_path);
