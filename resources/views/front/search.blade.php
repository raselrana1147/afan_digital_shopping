@extends('layouts.app')
@section('title',config('constant.company_name').' Product Search')
@section('main')
		<main class="main-content">
			<div class="breadcrumb-wrapper">
				...
				<h1 class="section-header__title">Product Search</h1>
			</div>
			<div class="wrapper">
				<div id="filter-loading" style="display:none">
					<img src="{{ asset('assets/frontend/assets/images/gears.svg') }}" alt="filter loading">
				</div>
