            ...
            <div class="beauty-health-inner">
                <div class="bh-top home-block-title">
                    <div class="collection-name">
                        <img class="collection-icon" src="{{ asset('assets/frontend/assets/images/beauty-health.png')}}" alt=""><a href="collection.html">Featured Items</a>
                    </div>
                ...
                <div class="bh-btm">
                    <div class="grid__item three-quarters bh-left small--one-whole medium--one-whole">
                        <div class="home-slideshow-block bh-slideshow">
                            <div class="home-gallery-slider">
                                @foreach (sliders('feature') as $slider)
                                            ...
                                            <div class="grid__item_wrapper">
                                                <div class="grid__image product-image">
                                                    <a href="{{ route('product.detail',$featured->slug) }}">
                                                        <img src="{{ asset('assets/backend/image/product/small/'.$featured->thumbnail)}}" alt="Demo Product Sample">
                                                    </a>
                                                    {{-- <div class="quickview">
                                                ...
                                                <p class="h6 product-title">
                                                    <a href="{{ route('product.detail',$featured->slug) }}">{{$featured->name}}</a>
                                                </p>
                                                <p class="product-price">
                                                    <strong>On Sale</strong>
                                                    <span class="money" >{{price_format($featured->current_price)}}</span>
                                                    @if ($featured->previous_price>$featured->current_price)
                                                        <span class="visually-hidden">Regular price</span>
                                                    <s><span class="money" >{{price_format($featured->previous_price)}}</span></s>
                                                    @endif
                                                ...
                                                <ul class="action-button">
                                                    <li class="add-to-cart-form">
                                                            ...
                                                            <div class="effect-ajax-cart">
                                                                ...
                                                                <button type="button" class="btn btn-1 add-to-cart add_to_cart_single" product_id="{{$featured->id}}" data-action="{{ route('add_to_cart_single') }}" title="Buy Now">
                                                    ...
                                                    <li class="wishlist">
                                                        <a class="wish-list btn add_to_wishlist" href="javascript:;" product_id="{{$featured->id}}" data-action="{{ route('add_to_wishlist') }}"><i class="fa fa-heart" title="Wishlist"></i></a>
                                                    </li>
                                                    {{-- <li class="email">
                    ...
                    <div class="grid__item one-quarter bh-right small--one-whole medium--one-whole">
                        <div class="brands-area">
                            ...
                            @foreach (brands('feature') as $brand)
                                <li class="">
                        ...
                        @if (!is_null(banner('feature')))
                           <div class="banner-area">
                            <a href="{{banner('feature')->url}}"><img src="{{ asset('assets/backend/image/banner/small/'.banner('feature')->image)}}" alt=""></a>
                            </div>
                        @endif
